...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React4.useRef(initialState);
  React4.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React4.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const controlledPropsRef = React4.useRef(controlledProps);
  if (true) {
    React4.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
  ...
  const reducerWithControlledState = React4.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React4.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React4.useCallback((action) => {
...
var formControlClasses = generateUtilityClasses2(COMPONENT_NAME2, ["root", "disabled", "error", "filled", "focused", "required"]);
...
var Portal = React22.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime11.jsx)(React22.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime11.jsx)(React22.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3YIMZKYZ.js.map
